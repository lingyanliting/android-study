...
public class CalPrimeActivity extends BaseActivity {
			...
			mHandler = new Handler() {
				...
				public void handleMessage(Message msg) {
					if (msg.what == 0x123) {
						...
						// 使用Toast显示统计出来的所有质数
						Toast.makeText(thisActivity, nums.toString(), Toast.LENGTH_LONG).show();
					}
				}
			};
			Looper.loop();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_3_13);
