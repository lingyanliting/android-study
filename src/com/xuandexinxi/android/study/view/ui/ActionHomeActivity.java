...
public class ActionHomeActivity extends ActionBarActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_2_58);
	...
	public boolean onOptionsItemSelected(MenuItem mi) {
		...
		case R.id.plain_item:
			Toast toast = Toast.makeText(ActionHomeActivity.this, "您单击了普通菜单项", Toast.LENGTH_SHORT);
			toast.show();
			break;
		}
		return true;
