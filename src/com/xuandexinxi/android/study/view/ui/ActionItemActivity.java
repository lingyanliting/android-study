...
public class ActionItemActivity extends BaseActivity {
	private TextView txt;

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_2_57);
	...
	public boolean onOptionsItemSelected(MenuItem mi) {
		...
		case R.id.plain_item:
			Toast toast = Toast.makeText(thisActivity, "您单击了普通菜单项", Toast.LENGTH_SHORT);
			toast.show();
			break;
		}
		return true;
