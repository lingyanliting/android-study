package com.xuandexinxi.android.study.widget;
...
public class ShimmerViewHelper {
	...
	private void resetLinearGradient() {
		...
		// view
		linearGradient = new LinearGradient(-view.getWidth(), 0, 0, 0, new int[] { primaryColor, reflectionColor,
				primaryColor, }, new float[] { 0, 0.5f, 1 }, Shader.TileMode.CLAMP);
